...
class RentingShoesPage extends StatefulWidget {
  final String? initialBrand;
  
  const RentingShoesPage({Key? key, this.initialBrand}) : super(key: key);
  
  @override
  _RentingShoesPageState createState() => _RentingShoesPageState();
}

class _RentingShoesPageState extends State<RentingShoesPage> {
          ...
          child: Center(
            child: ConstrainedBox(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Header with Renting Shoes and Buying? button
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(                               // ✅ this adds the outline
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Color(0xFF1E1E1E), // Dark background for search bar
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: [
                        ...
                        ...['Nike', 'Adidas', 'Puma', 'New Balance', 'Salomon'].map((brand) => 
                          DropdownMenuItem<String>(
                            value: brand,
                  ...
                  // Renting Products with Brand Filter
                  StreamBuilder<List<Product>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      var rentingProducts = products.where((p) => p.type == ProductType.rent).toList();
                      
                      if (_selectedBrand != null) {
                        rentingProducts = rentingProducts.where((p) => p.brand == _selectedBrand).toList();
                      }
                      
                      if (_searchQuery.isNotEmpty) {
                        rentingProducts = rentingProducts.where((p) => 
                                ...
                                Text(
                                  _searchQuery.isNotEmpty
                                    ...
                                    : _selectedBrand != null 
                                      ...
                                      : 'No products available for renting',
                      ...
                      return Wrap(
                        spacing: 16,
                        runSpacing: 16,
                        children: rentingProducts.map((product) {
                          return SizedBox(
